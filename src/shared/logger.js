 ...
 */
self.createSimpleLogger = function createSimpleLogger(options = {}) {
  const logger = new self.Logger(options);
 ...
 */
self.extensionLogger = self.createSimpleLogger({
  prefix: '[PDF Scanner]',
  level: 'info'
});

self.serviceLogger = new self.Logger({
